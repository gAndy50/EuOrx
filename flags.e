...
--Structure Flags
public enum orxSTRUCTURE_ID_ANIMPOINTER = 0,
...
public enum orxSTRUCTURE_STORAGE_TYPE_LINKLIST = 0,
...
--Timeline Flags
public enum orxTIMELINE_EVENT_TRACK_START = 0,
			orxTIMELINE_EVENT_TRACK_STOP,
			orxTMELINE_EVENT_TRACK_ADD,
...
--Plugin Flags
public constant orxPLUGIN_KU32_FLAG_CORE_ID =        #010000000,
				orxPLUGIN_KU32_MASK_PLUGIN_ID     =   #00000FF00,
				orxPLUGIN_KU32_SHIFT_PLUGIN_ID    =      8,
				orxPLUGIN_KU32_MASK_FUNCTION_ID     = #0000000FF,
				orxPLUGIN_KU32_FUNCTION_ARG_SIZE  =      128
				
public enum orxPLUGIN_FUNCTION_ID_NONE = orxENUM_NONE

--Camera Flags
public constant orxCAMERA_KU32_FLAG_NONE = 0,
