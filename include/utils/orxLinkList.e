...
public constant xorxLinkList_Clean = orxDefine("orxLinkList_Clean",{C_POINTER},C_INT)
...
public constant xorxLinkList_AddStart = orxDefine("orxLinkList_AddStart",{C_POINTER,C_POINTER},C_INT),
