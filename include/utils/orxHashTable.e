...
public constant xorxHashTable_Create = orxDefine("orxHashTable_Create",{C_UINT,C_UINT,C_INT},C_POINTER)
...
public constant xorxHashTable_Delee = orxDefine("orxHashTable_Delete",{C_POINTER},C_INT)
...
public constant xorxHashTable_Clear = orxDefine("orxHashTable_Clear",{C_POINTER},C_INT),
...
public constant xorxHashTable_Get = orxDefine("orxHashTable_Get",{C_POINTER,C_LONG},C_POINTER)
...
public constant xorxHashTable_Retrieve = orxDefine("orxHashTable_Retrieve",{C_POINTER,C_LONG},C_POINTER)
...
public constant xorxHashTable_Set = orxDefine("orxHashTable_Set",{C_POINTER,C_LONG,C_POINTER},C_INT)
...
public constant xorxHashTable_Add = orxDefine("orxHashTable_Add",{C_POINTER,C_LONG,C_POINTER},C_INT)
...
public constant xorxHashTable_Remove = orxDefine("orxHashTable_Remove",{C_POINTER,C_LONG},C_INT),
