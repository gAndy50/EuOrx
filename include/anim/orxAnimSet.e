...
constant
	xorxAnimSet_Setup              = orxDefine( "orxAnimSet_Setup", {} ),
	xorxAnimSet_Init               = orxDefine( "orxAnimSet_Init", {}, C_INT ),
	xorxAnimSet_Exit               = orxDefine( "orxAnimSet_Exit", {} ),
	xorxAnimSet_Create             = orxDefine( "orxAnimSet_Create", {C_UINT}, C_POINTER ),
	...
	xorxAnimSet_AddAnim            = orxDefine( "orxAnimSet_AddAnim", {C_POINTER,C_POINTER}, C_UINT ),
	...
	xorxAnimSet_AddLink            = orxDefine( "orxAnimSet_AddLink", {C_POINTER,C_UINT,C_UINT}, C_UINT ),
	...
	xorxAnimSet_GetLinkProperty    = orxDefine( "orxAnimSet_GetLinkProperty", {C_POINTER,C_UINT,C_UINT} ),
...
public function orxAnimSet_Create( atom _u32Size )
	return orxFunc( xorxAnimSet_Create, {_u32Size} )
end function
...
public function orxAnimSet_SetLinkProperty( atom _pstAnimSet, atom _u32LinkID, atom _u32Property, atom _u32Value )
...
public function orxAnimSet_GetAnimStorageSize( atom _pstAnimSet )
	return orxFunc( xorxAnimSet_GetAnimStorageSize, {_pstAnimSet} )
end function
