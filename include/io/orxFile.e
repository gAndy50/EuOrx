...
constant
	xorxFile_Setup                       = orxDefine( "orxFile_Setup", {} ),
...
public constant
	orxFILE_INFO_s64Size      =  8, --orxS64
	orxFILE_INFO_s64TimeStamp = 16, --orxS64
	orxFILE_INFO_u32Flags     = 20, --orxU32
	orxFILE_INFO_hInternal    = 24, --orxHANDLE
	orxFILE_INFO_zName        = 28, --orxCHAR
	orxFILE_INFO_zPattern     = 32, --orxCHAR
	orxFILE_INFO_zPath        = 36, --orxCHAR
	orxFILE_INFO_zFullName    = 40, --orxCHAR
...
public function orxFile_Print( object _pstFile, object _zString )
	return orxFunc( xorxFile_Print, {_pstFile,_zString} )
end function

public function orxFile_Close( object _pstFile )
	return orxFunc( xorxFile_Close, {_pstFile} )
end function
­181.33