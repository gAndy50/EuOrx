...
public enum type orxJOYSTICK_BUTTON
 ...
 orxJOYSTICK_BUTTON_A_1 = 0,
  ...
  orxJOYSTICK_BUTTON_NONE = 0xFFFFFFFF
...
public enum type orxJOYSTICK_AXIS
 ...
 orxJOYSTICK_AXIS_LX_1 = 0,
  ...
  orxJOYSTICK_AXIS_NONE = 0xFFFFFFFF
	
end type

public constant orxJOYSTICK_KU32_MIN_ID = 1

constant xorxJoystick_Setup = orxDefine("orxJoystick_Setup",{})
...
constant xorxJoystick_Init = orxDefine("orxJoystick_Init",{},C_INT),
...
public function orxJoystick_GetAxisName(object _eAxis)
 ...
 return orxFunc(xorxJoystick_GetAixsName,{_eAxis})
