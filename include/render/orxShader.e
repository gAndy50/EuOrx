...
public constant
				orxSHADER_PARAM_stNode = 8, --LinkList Node
...
constant
	xorxShader_Setup            = orxDefine( "orxShader_Setup", {} ),
	...
	xorxShader_AddFloatParam    = orxDefine( "orxShader_AddFloatParam", {C_POINTER,C_STRING,C_UINT,C_FLOAT}, C_INT ),
	...
	xorxShader_SetTextureParam  = orxDefine( "orxShader_SetTextureParam", {C_POINTER,C_STRING,C_UINT,C_POINTER}, C_INT ),
