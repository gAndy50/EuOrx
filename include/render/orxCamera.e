...
constant
	xorxCamera_Setup            = orxDefine( "orxCamera_Setup", {} ),
	xorxCamera_Init             = orxDefine( "orxCamera_Init", {}, C_INT ),
	xorxCamera_Exit             = orxDefine( "orxCamera_Exit", {} ),
	xorxCamera_Create           = orxDefine( "orxCamera_Create", {C_UINT}, C_POINTER ),
	...
	xorxCamera_AddGroupID       = orxDefine( "orxCamera_AddGropuID", {C_POINTER,C_STRING,C_BOOL}, C_INT ),
	...
	xorxCamera_SetFrustum       = orxDefine( "orxCamera_SetFrustum", {C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT}, C_INT ),
	...
	xorxCamera_GetFrame         = orxDefine( "orxCamera_GetFrame", {C_POINTER}, C_POINTER ),
	xorxCamera_SetParent        = orxDefine( "orxCamera_SetParent", {C_POINTER,C_POINTER}, C_INT ),
