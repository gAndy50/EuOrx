...
public include "utils/orxTree.e"

public constant orxSTRUCTURE_GUID_MAGIC_TAG_DELETED = 0xDEFACED0DEADC0DE--ULL

public constant orxSTRUCTURE_GUID_MASK_STRUCTURE_ID = 0x00000000000000FF--ULL
public constant orxSTRUCTURE_GUID_SHIFT_STRUCTURE_ID = 0

public constant orxSTRUCTURE_GUID_MASK_ITEM_ID = 0x00000000FFFFFF00--ULL
public constant orxSTRUCTURE_GUID_SHIFT_ITEM_ID = 8

public constant orxSTRUCTURE_GUID_MASK_INSTANCE_ID = 0xFFFFFFFF00000000--ULL
...
constant
	xorxStructure_Setup          = orxDefine( "orxStructure_Setup", {} ),
	xorxStructure_Init           = orxDefine( "orxStructure_Init", {}, C_INT ),
	xorxStructure_Exit           = orxDefine( "orxStructure_Exit", {} ),
	xorxStructure_Register       = orxDefine( "orxStructure_Register", {C_INT,C_INT,C_INT,C_UINT,C_UINT,C_POINTER}, C_INT ),
	xorxStructure_Unregister     = orxDefine( "orxStructure_Unregister", {C_INT}, C_INT ),
	xorxStructure_Create         = orxDefine( "orxStructure_Create", {C_INT}, C_POINTER ),
	xorxStructure_Delete         = orxDefine( "orxStructure_Delete", {C_POINTER}, C_INT ),
	xorxStructure_GetStorageType = orxDefine( "orxStructure_GetStorageType", {C_INT}, C_INT ),
	...
	xorxStructure_Get            = orxDefine( "orxStructure_Get", {C_LONG}, C_POINTER ),
	...
	xorxStructure_LogAll         = orxDefine( "orxStructure_LogAll", {C_BOOL}, C_INT )
