...
constant
	xorxFXPointer_Setup                        = orxDefine( "orxFXPointer_Setup", {} ),
	xorxFXPointer_Init                         = orxDefine( "orxFXPointer_Init", {}, C_INT ),
	xorxFXPointer_Exit                         = orxDefine( "orxFXPointer_Exit", {} ),
	xorxFXPointer_Create                       = orxDefine( "orxFXPointer_Create", {}, C_POINTER ),
	...
	xorxFXPointer_AddFX                        = orxDefine( "orxFXPointer_AddFX", {C_POINTER,C_POINTER}, C_INT ),
	...
	xorxFXPointer_Synchronize                  = orxDefine( "orxFXPointer_Synchronize", {C_POINTER,C_POINTER}, C_INT ),
	xorxFXPointer_GetTime                      = orxDefine( "orxFXPointer_GetTime", {C_POINTER}, C_FLOAT ),
...
public procedure orxFXPointer_Enable( object FX, atom _bEn )
	orxProc( xorxFXPointer_Enable, {FX,_bEn} )
end procedure
