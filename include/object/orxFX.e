...
public constant xorxFX_Setup = orxDefine("orxFX_Setup",{}),
...
public function orxFX_Apply(object fx,object _pstObject,atom _fStartTime,atom _fEndTime)
 ...
 return orxFunc(xorxFX_Appy,{fx,_pstObject,_fStartTime,_fEndTime})
	
end function

public procedure orxFX_Enable(object _pstFX,atom _bEnable)

 orxProc(xorxFX_Enable,{_pstFX,_bEanble})
...
public constant xorxFX_AddAlpha = orxDefine("orxFX_AddAlpha",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddRGB = orxDefine("orxFX_AddRGB",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddHSL = orxDefine("orxFX_AddHSL",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)
...
public function orxFX_AddHSL(object FX,atom _fStartTime,atom _fEndTime,atom _fCyclePeriod,atom _fCyclePhase,atom _fAmp,atom _fAcc,object _pvStartColor,object _pvEndColor,atom _eCurve,atom _fPow,atom _u32Flags)
 ...
 return orxFunc(xorxFX_AddHSL,{FX,_fStartTime,_fEndTime,_fCyclePeriod,_fCyclePhase,_fAmp,_fAcc,_pvStartColor,_pvEndColor,_eCurve_fPow,_u32Flags})
	
end function

public constant xorxFX_AddHSV = orxDefine("orxFX_AddHSV",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)

public function orxFX_AddHSV(object FX,atom _fStartTime,atom _fEndTime,atom _fCyclePeriod,atom f_CyclePhase,atom _fAmp,atom f_Acc,object _pvStartColor,object _pvEndColor,atom _eCurve,atom _fPow,atom _u32Flags)
...
public constant xorxFX_AddRotation = orxDefine("orxFX_AddRotation",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddScale = orxDefine("orxFX_AddScale",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddPosition = orxDefine("orxFX_AddPosition",{C_POINTER,C_FLOAT,C_FLOAT,C_FLAOT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddSpeed = orxDefine("orxFX_AddSpeed",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_POINTER,C_POINTER,C_INT,C_FLOAT,C_UINT},C_INT)
...
public function orxFX_AddSpeed(object FX,atom _fStartTime,atom _fEndTime,atom _fCyclePeriod,atom _fCyclePhase,atom _fAmp,atom _fAcc,object _pvStartSpeed,object _pvEndSpeed,atom _eCurve,atom _fPow,atom _u32Flags)
 ...
 return orxFunc(xorxFX_AddSpeed,{FX,_fStartTime,_fEndTime,_fCyclePeriod,_fCyclePhase,_fAmp,_fAcc,_pvStartSpeed,pvEndSpeed,_eCurve,_fPow,_u32Flags})
	
end function

public constant xorxFX_AddVolume = orxDefine("orxFX_AddVolume",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddPitch = orxDefine("orxFX_AddPitch",{C_POINTER,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_FLOAT,C_INT,C_FLOAT,C_UINT},C_INT)
...
public constant xorxFX_AddSlotFromConfig = orxDefine("orxFX_AddSlotFromConfig",{C_POINTER,C_STRING},C_INT),
