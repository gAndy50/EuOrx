...
public include "object/orxFrame.e"
...
constant
	xorxSpawner_Setup                = orxDefine( "orxSpawner_Setup", {} ),
	...
	xorxSpawner_IsEnabled            = orxDefine( "orxSpawner_IsEnabled", {C_POINTER}, C_BOOL ),
	xorxSpawner_Reset                = orxDefine( "orxSpawner_Reset", {C_POINTER} ),
	...
	xorxSpawner_SetWaveSize          = orxDefine( "orxSpawner_SetWaveSize", {C_POINTER,C_UINT}, C_INT ),
	...
	xorxSpawner_SetObjectSpeed       = orxDefine( "orxSpawner_SetObjectSpeed", {C_POINTER,C_POINTER}, C_INT ),
	xorxSpawner_GetObjectSpeed       = orxDefine( "orxSpawner_GetObjectSpeed", {C_POINTER,C_POINTER}, C_POINTER ),
	xorxSpawner_Spawn                = orxDefine( "orxSpawner_Spawn", {C_POINTER,C_UINT}, C_UINT ),
	xorxSpawner_GetFrame             = orxDefine( "orxSpawner_GetFrame", {C_POINTER}, C_POINTER ),
	xorxSpawner_SetPosition          = orxDefine( "orxSpawner_SetPosition", {C_POINTER,C_POINTER}, C_INT ),
	...
	xorxSpawner_SetParent            = orxDefine( "orxSpawner_SetParent", {C_POINTER,C_POINTER}, C_INT ),
	xorxSpawner_GetParent            = orxDefine( "orxSpawner_GetParent", {C_POINTER}, C_POINTER ),
	xorxSpawner_GetName              = orxDefine( "orxSpawner_GetName", {C_POINTER}, C_STRING )

public procedure orxSpawner_Setup()
...
public function orxSpawner_SetTotalObjectLimit( object Sp, atom _Lim )
	return orxFunc( xorxSpawner_SetTotalObjectLimit, {Sp,_Lim} )
end function
