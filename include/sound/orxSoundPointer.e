...
constant
	xorxSoundPointer_Setup                 = orxDefine( "orxSoundPointer_Setup", {} ),
	xorxSoundPointer_Init                  = orxDefine( "orxSoundPointer_Init", {}, C_INT ),
	xorxSoundPointer_Exit                  = orxDefine( "orxSoundPointer_Exit", {} ),
	xorxSoundPointer_Create                = orxDefine( "orxSoundPointer_Create", {}, C_POINTER ),
	...
	xorxSoundPointer_SetVolume             = orxDefine( "orxSoundPointer_SetVolume", {C_POINTER,C_FLOAT}, C_INT ),
	xorxSoundPointer_SetPitch              = orxDefine( "orxSoundPointer_SetPitch", {C_POINTER,C_FLOAT}, C_INT ),
	xorxSoundPointer_Play                  = orxDefine( "orxSoundPointer_Play", {C_POINTER}, C_INT ),
	...
	xorxSoundPointer_AddSound              = orxDefine( "orxSoundPointer_AddSound", {C_POINTER,C_POINTER}, C_INT ),
