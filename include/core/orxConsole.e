...
constant
	xorxConsole_Setup                 = orxDefine( "orxConsole_Setup", {} ),
	xorxConsole_Init                  = orxDefine( "orxConsole_Init", {}, C_INT ),
	xorxConsole_Exit                  = orxDefine( "orxConsole_Exit", {} ),
	xorxConsole_Enable                = orxDefine( "orxConsole_Enable", {C_BOOL} ),
	xorxConsole_IsEnabled             = orxDefine( "orxConsole_IsEnabled", {}, C_BOOL ),
	xorxConsole_IsInsertMode          = orxDefine( "orxConsole_IsInsertMode", {}, C_BOOL ),
	xorxConsole_SetToggle             = orxDefine( "orxConsole_SetToggle", {C_INT,C_INT,C_INT}, C_INT ),
	xorxConsole_Log                   = orxDefine( "orxConsole_Log", {C_STRING}, C_INT ),
	xorxConsole_SetFont               = orxDefine( "orxConsole_SetFont", {C_POINTER}, C_INT ),
	xorxConsole_GetFont               = orxDefine( "orxConsole_GetFont", {}, C_POINTER ),
	xorxConsole_SetLogLineLength      = orxDefine( "orxConsole_SetLogLineLength", {C_UINT}, C_INT ),
	xorxConsole_GetLogLineLength      = orxDefine( "orxConsole_GetLogLineLength", {}, C_UINT ),
	xorxConsole_GetCompletionCount    = orxDefine( "orxConsole_GetCompletionCount", {C_POINTER}, C_UINT ),
	xorxConsole_GetCompletion         = orxDefine( "orxConsole_GetCompletion", {C_UINT,C_POINTER}, C_STRING ),
	xorxConsole_GetTrailLogLine       = orxDefine( "orxConsole_GetTrailLogLine", {C_UINT}, C_STRING ),
