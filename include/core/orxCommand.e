...
public constant
	orxCOMMAND_VAR_DEF_ZNAME  = 0,
	orxCOMMAND_VAR_DEF_ETYPE  = 4,
	SIZEOF_ORXCOMMAND_VAR_DEF = 8

public constant
	orxCOMMAND_VAR_TYPE_VVALUE   = 0,
...
constant
	xorxCommand_Setup                   = orxDefine( "orxCommand_Setup", {} ),
	xorxCommand_Init                    = orxDefine( "orxCommand_Init", {}, C_INT ),
	xorxCommand_Exit                    = orxDefine( "orxCommand_Exit", {} ),
	xorxCommand_Register                = orxDefine( "orxCommand_Register", {C_STRING,C_POINTER,C_UINT,C_UINT,C_POINTER,C_POINTER}, C_INT ),
	...
	xorxCommand_AddAlias                = orxDefine( "orxCommand_AddAlias", {C_STRING,C_STRING,C_STRING}, C_INT ),
	...
	xorxCommand_GetPrototype            = orxDefine( "orxCommand_GetPrototype", {C_STRING}, C_STRING ),
	xorxCommand_GetNext                 = orxDefine( "orxCommand_GetNext", {C_STRING,C_STRING,C_POINTER}, C_STRING ),
	xorxCommand_Evaluate                = orxDefine( "orxCommand_Evalute", {C_STRING,C_POINTER}, C_POINTER ),
	xorxCommand_EvaluateWithGUID        = orxDefine( "orxCommand_EvaluateWithGUID", {C_STRING,C_LONG,C_POINTER}, C_POINTER ),
	xorxCommand_Execute                 = orxDefine( "orxCommand_Execute", {C_STRING,C_UINT,C_POINTER,C_POINTER}, C_POINTER ),
	xorxCommand_ParseNumericalArguments = orxDefine( "orxCommand_ParseNumericalArguments", {C_UINT,C_POINTER,C_POINTER} ),
...
public function orxCommand_AddAlias( object _zAlias, object _zCommand, object _zArgs )
	return orxFunc( xorxCommand_AddAlias, {_zAlias,_zCommand,_zArgs} )
end function
...
public function orxCommand_EvaluateWithGUID( object _zCmdLine, atom _u64ID, object _pstRes )
