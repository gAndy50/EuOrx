...
constant
	xorxLocale_Setup              = orxDefine( "orxLocale_Setup", {} ),
	xorxLocale_Init               = orxDefine( "orxLocale_Init", {}, C_INT ),
	xorxLocale_Exit               = orxDefine( "orxLocale_Exit", {} ),
	xorxLocale_SelectLanguage     = orxDefine( "orxLocale_SelectLanguage", {C_STRING}, C_INT ),
	xorxLocale_GetCurrentLanguage = orxDefine( "orxLocale_GetCurrentLanguage", {}, C_STRING ),
	...
	xorxLocale_HasString          = orxDefine( "orxLocale_HasString", {C_STRING}, C_BOOL ),
