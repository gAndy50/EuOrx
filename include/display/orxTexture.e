...
constant
	xorxTexture_Setup            = orxDefine( "orxTexture_Setup", {} ),
	xorxTexture_Init             = orxDefine( "orxTexture_Init", {}, C_INT ),
	xorxTexture_Exit             = orxDefine( "orxTexture_Exit", {} ),
	xorxTexture_Create           = orxDefine( "orxTexture_Create", {}, C_POINTER ),
	...
	xorxTexture_GetBitmap        = orxDefine( "orxTexture_GetBitmap", {C_POINTER}, C_POINTER ),
...
public enum type orxTEXTURE_EVENT
	...
	orxTEXTURE_EVENT_NONE = 0xFFFFFFFF -- orxENUM_NONE
...
public function orxTexture_LinkBitmap( object _pstTexture, object _pstBitmap, object _zDataName, atom _bTransferOwnership )
	return orxFunc( xorxTexture_LinkBitmap, {_pstTexture,_pstBitmap,_zDataName,_bTransferOwnership} )
end function
