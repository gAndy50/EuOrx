...
constant
	xorxText_Setup            = orxDefine( "orxText_Setup", {} ),
	xorxText_Init             = orxDefine( "orxText_Init", {}, C_INT ),
	xorxText_Exit             = orxDefine( "orxText_Exit", {} ),
	xorxText_Create           = orxDefine( "orxText_Create", {}, C_POINTER ),
	...
	xorxText_GetName          = orxDefine( "orxText_GetName", {C_POINTER}, C_STRING ),
	...
	xorxText_GetSize          = orxDefine( "orxText_GetSize", {C_POINTER,C_POINTER,C_POINTER}, C_INT ),
	...
	xorxText_SetSize          = orxDefine( "orxText_SetSize", {C_POINTER,C_FLOAT,C_FLOAT,C_POINTER}, C_INT ),
