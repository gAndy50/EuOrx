...
--public include "orxDisplay.e"

public constant orxGRAPHIC_KU32_FLAG_NONE = 0x000000000, 
...
public constant xorxGraphic_Setup = orxDefine("orxGraphic_Setup",{}),
...
constant xorxGraphic_GetAlignFlags = orxDefine("orxGraphic_GetAlignFlags",{C_STRING},C_UINT),
...
public constant xorxGraphic_Create = orxDefine("orxGraphic_Create",{},C_POINTER),
...
constant xorxGraphic_SetData = orxDefine("orxGraphic_SetData",{C_POINTER,C_POINTER},C_INT),
...
public constant xorxGraphic_SetFlip = orxDefine("orxGraphic_SetFlip",{C_POINTER,C_BOOL,C_BOOL},C_INT),
...
constant xorxGraphic_SetPivot = orxDefine("orxGraphic_SetPivot",{C_POINTER,C_POINTER},C_INT),
...
public constant xorxGraphic_SetSize = orxDefine("orxGraphic_SetSize",{C_POINTER,C_POINTER},C_INT),
...
public function orxGraphic_GetOrigin(object _pstGraphic,object _pvOrigin)
 ...
 return orxFunc(xorxGraphic_GetOrihin,{_pstGraphic,_pvOrigin})
...
public constant xorxGraphic_SetBlendMode = orxDefine("orxGraphic_SetBlendMode",{C_POINTER,C_INT},C_INT),
