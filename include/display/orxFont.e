...
constant
	xorxFont_Setup                 = orxDefine( "orxFont_Setup", {} ),
	xorxFont_Init                  = orxDefine( "orxFont_Init", {}, C_INT ),
	xorxFont_Exit                  = orxDefine( "orxFont_Exit", {} ),
	xorxFont_Create                = orxDefine( "orxFont_Create", {}, C_POINTER ),
	...
	xorxFont_GetDefaultFont        = orxDefine( "orxFont_GetDefaultFont", {}, C_POINTER ),
	xorxFont_SetTexture            = orxDefine( "orxFont_SetTexture", {C_POINTER,C_POINTER}, C_INT ),
	...
	xorxFont_GetTexture            = orxDefine( "orxFont_GetTexture", {C_POINTER}, C_POINTER ),
	...
	xorxFont_GetMap                = orxDefine( "orxFont_GetMap", {C_POINTER}, C_POINTER ),
	xorxFont_GetName               = orxDefine( "orxFont_GetName", {C_POINTER}, C_STRING )
